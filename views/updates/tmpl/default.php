...
<script type="text/javascript">
    Joomla.submitbutton = function(pressbutton) {
        if (pressbutton == 'sites.delete') {
            if (confirm(Joomla.JText._('COM_COMMAND_UPDATES_CONFIRM_DELETE_PROMPT'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_command&view=updates'); ?>" method="post" name="adminForm" id="adminForm">
    <fieldset id="filter-bar">
        <div class="filter-search fltlft">
            <label class="filter-search-lbl" for="filter_search"><?php echo JText::sprintf('COM_COMMAND_SEARCH_LABEL', JText::_('COM_COMMAND_UPDATES_ITEMS')); ?></label>
    ...
    <table class="adminlist" style="clear: both;">
        <thead>
            <tr>
                ...
                <th width="10%">
                    <?php echo JHtml::_('grid.sort', 'COM_COMMAND_UPDATES_HEADING_ID', 'id', $listDirn, $listOrder); ?>
                </th>
            </tr>
        </thead>
        <tbody>
            <?php if (count($this->items) == 0): ?>
                <tr class="row0">
                    <td align="center" colspan="7">
                        <?php echo JText::_('COM_COMMAND_UPDATES_NO_UPDATES'); ?>
                    </td>
                </tr>
            <?php endif; ?>
